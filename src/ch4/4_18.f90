...
contains 
    ...
    ! Data Dictionary
        real(16) :: i_D                              ! The current flow through the diode in amperes
        real(16), intent(in) :: v_D                  ! The voltage across the diode, in volts
        real(16), intent(in) :: I_O                  ! The leakage current of the diode, in amperes

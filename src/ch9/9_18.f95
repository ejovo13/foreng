...
print 99, 0.0,0.0
call least_squares_fit(X, Y, 2, u)


! ! (b)
print 99, -0.1, 0.1
call add_noise(Y, noise, Y_noise, -0.1, 0.1)
call least_squares_fit(X, Y_noise, 2, u)
...
! ! (e)
print 99, -2.0, 2.0
call add_noise(Y, noise, Y_noise, -2.0, 2.0)
call least_squares_fit(X, Y_noise, 2, u)

! ! (f)
print 99, -1.0, 3.0
call add_noise(Y, noise, Y_noise, -1.0, 3.0)
call least_squares_fit(X, Y_noise, 2, u)
